...
export default class Test {
  ...
  static async login() {
    ...
    let accessData = await Test.driver.findElements(
      By.css(".oxd-sheet .oxd-text--p")
    );
    let username = (await accessData[0].getText()).split(" ").pop() || "";
    let password = (await accessData[1].getText()).split(" ").pop() || "";

    await Test.driver
      .findElement(By.css('[placeholder="Username"]'))
      .sendKeys(username);
    await Test.driver
      .findElement(By.css('[placeholder="Password"]'))
      .sendKeys(password);
  ...
  async addPayGrade() {
    await Test.driver
      .wait(
        until.elementLocated(
          By.xpath(
            '//a[@class="oxd-main-menu-item" and .//span[text()="Admin"]]'
          )
        )
      )
      .click();
    ...
    await Test.driver
      .findElement(
        By.xpath(
          '//*[@id="app"]/div[1]/div[2]/div[2]/div[1]/div/form/div[2]/button[2]'
        )
      )
      .click();
  ...
  async addAssignedCurency() {
    ...
    await Test.driver
      .wait(
        until.elementLocated(
          By.xpath(
            '//*[@id="app"]/div[1]/div[2]/div[2]/div[2]/div/div[1]/div/button'
          )
        )
      )
      .click();
    ...
    await Test.driver
      .findElement(
        By.xpath(
          '//*[@id="app"]/div[1]/div[2]/div[2]/div[2]/form/div[1]/div/div/div/div[2]/div/div/div[2]'
        )
      )
      .click();
    ...
    await Test.driver
      .findElement(
        By.xpath(
          `//div[@role="option" and .//span[text()="AED - Utd. Arab Emir. Dirham"]]`
        )
      )
      .click();
    ...
    await Test.driver
      .findElement(
        By.xpath(
          `//*[@id="app"]/div[1]/div[2]/div[2]/div[2]/form/div[2]/div/div[1]/div/div[2]/input`
        )
      )
      .sendKeys(1000);
    ...
    await Test.driver
      .findElement(
        By.xpath(
          `//*[@id="app"]/div[1]/div[2]/div[2]/div[2]/form/div[2]/div/div[2]/div/div[2]/input`
        )
      )
      .sendKeys(2000);
    ...
    await Test.driver
      .findElement(
        By.xpath(
          `//*[@id="app"]/div[1]/div[2]/div[2]/div[2]/form/div[3]/button[2]`
        )
      )
      .click();
  ...
  async checkCurencyExistance() {
    return (await Test.driver.wait(
      until.elementLocated(
        By.className(`oxd-table-row oxd-table-row--with-border`)
      )
    ))
      ? "success"
      : null;
  ...
  async deleteCurency() {
    await Test.driver
      .findElement(By.className(`oxd-icon-button oxd-table-cell-action-space`))
      .click();
    await Test.driver
      .findElement(
        By.className(
  ...
  async checkAndDeletePayGradeExistance() {
    await Test.driver
      .wait(
        until.elementLocated(
          By.xpath(
            `//div[@class="oxd-table-card"]/div/div[2]/div[text()="${RandomName}"]/ancestor :: div[@class="oxd-table-card"]/div/div[4]/div/button`
          )
        )
      )
      .click();
